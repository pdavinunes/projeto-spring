    ...
    alterarStatus= (lancamento, status) => {
        this.service.alterarStatus(lancamento.id, status)
            .then(resp => {
                ...
                msgs.msgSucesso("Status atualizado com sucesso")
            })
    }
                ...
                <div className="row">
                    <div className="col-md-6">
                        <div className="bs-component">
                            ...
                            <button onClick={this.preparaFormCadastro} type="button" className="btn btn-danger"><i className="pi pi-plus"></i> Cadastrar</button>
                        </div>
                    </div>
                </div>
                <br />
